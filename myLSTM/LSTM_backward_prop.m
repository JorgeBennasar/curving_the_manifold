...
grad_hidden.dW_f = dW_f + lambda/m_trials*param.W_f + correlation_reg*D.*param.W_f;
grad_hidden.dW_i = dW_i + lambda/m_trials*param.W_i + correlation_reg*D.*param.W_i;
grad_hidden.dW_c = dW_c + lambda/m_trials*param.W_c + correlation_reg*D.*param.W_c;
grad_hidden.dW_o = dW_o + lambda/m_trials*param.W_o + correlation_reg*D.*param.W_o;
